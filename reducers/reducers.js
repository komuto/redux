...
const transaction = {
  ...
  newOrders: transactionReducers.getOrders,
  newOrderDetail: transactionReducers.getOrderDetail,
  processingOrders: transactionReducers.getOrders,
  processingOrderDetail: transactionReducers.getOrderDetail,
  updateStatus: transactionReducers.updateStatus,
  buyerComplainedOrders: transactionReducers.getOrders,
  sellerComplainedOrders: transactionReducers.getOrders,
  buyerComplainedOrders2: transactionReducers.getOrders,
  sellerComplainedOrders2: transactionReducers.getOrders,
  buyerComplainedOrderDetail: transactionReducers.getOrderDetail,
  sellerComplainedOrderDetail: transactionReducers.getOrderDetail,
  buyerComplaintDiscussion: transactionReducers.createDiscussion,
  sellerComplaintDiscussion: transactionReducers.createDiscussion,
