...
function * dataSaga () {
  ...
  yield takeEvery(addressActions.addAddressAction.request, addressSaga.addAddress)
  yield takeEvery(addressActions.updateAddressAction.request, addressSaga.updateAddress)
  yield takeEvery(addressActions.deleteAddressAction.request, addressSaga.deleteAddress)
  yield takeEvery(addressActions.addressDetailAction.request, addressSaga.getAddressDetail)
  yield takeEvery(addressActions.listAddressAction.request, addressSaga.getListAddress)
  yield takeEvery(addressActions.primaryAddressAction.request, addressSaga.getPrimaryAddress)
