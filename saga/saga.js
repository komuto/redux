...
function * dataSaga () {
  ...
  yield takeEvery(typeReq(userActions.ADD_TO_BUCKET), userSaga.addToBucket)
  yield takeEvery(typeReq(userActions.COUNT_BUCKET), userSaga.countBucket)
  yield takeEvery(typeReq(userActions.GET_BUCKET), userSaga.getBucket)
  ...
  yield takeEvery(typeReq(wishlistActions.GET_WISHLIST), wishlistSaga.wishlist)
  yield takeEvery(typeReq(reviewActions.GET_REVIEW), reviewSaga.getReview)
  yield takeEvery(typeReq(reviewActions.ADD_REVIEW), reviewSaga.addReview)
  yield takeEvery(typeReq(reviewActions.LIST_REVIEW), reviewSaga.listReviewPagination)
  ...
  yield takeEvery(typeReq(productActions.GET_PROMO), productSaga.getPromo)
}
