...
export const ADD_TRANSACTION_REVIEWS = 'ADD_TRANSACTION_REVIEWS'
 ...
 * @state transactionReviews
 */
export const addTransactionReviews = params => buildAction(typeReq(ADD_TRANSACTION_REVIEWS), params)
